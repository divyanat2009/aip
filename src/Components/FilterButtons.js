...
import { faPodcast, faSeedling, faBookOpen, faDoorOpen, faHome } from '@fortawesome/free-solid-svg-icons';
    ...
    render(){
        return(
            <section className="filter-button-row">
                ...
                <p><FontAwesomeIcon className="filter-icon" icon={faSeedling} /></p>
